...
**M5 · Pricing & packaging.** Implement the decided structure: **lead with annual $39.99/yr**, monthly $4.99/mo, family plan (~$59.99/yr, up to 4 children), regional price tiers (UK £3.99/£29.99, HK ~HK$38 — App Store Connect price points, not FX). Work: Stripe multi-price products + plan picker (today: single `stripe_price_id`), matching Apple/Google IAP products, family-plan entitlement fan-out across a parent's children, **Apple Small Business Program enrolment** (15% vs 30%).
